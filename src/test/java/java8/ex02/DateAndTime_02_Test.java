...
public class DateAndTime_02_Test {
	...
	public void test_localDate_of() {
		...
		LocalDate localDate = LocalDate.of(2050, 12, 24);
	...
	public void test_localDate_parse() {
		...
		String dateString = "10/01/1990"; 
		LocalDate result = LocalDate.parse(dateString, DateTimeFormatter.ofPattern("dd/MM/yyyy"));
	...
	public void test_with() {
		...
		LocalDate result = localDate.with(ChronoField.YEAR, 2015).with(ChronoField.MONTH_OF_YEAR, 2).with(ChronoField.DAY_OF_MONTH, 5);
