...
public class DateAndTime_04_Test {
    ...
    public void test_localDateTime_format() {
        ...
        LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(2017, 11, 27),LocalTime.of(12, 0, 0));

        // TODO Formatter l'heure pour que le test soit passant
        String result = localDateTime.format(DateTimeFormatter.ofPattern("yyyy '-' MM/dd HH:ss"));
